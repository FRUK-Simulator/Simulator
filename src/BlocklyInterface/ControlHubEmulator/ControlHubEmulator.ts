import { ControlHubEmulatorConfig } from "./ControlHubEmulatorConfig";
...
export class ControlHubEmulator {
  ...
  private config: ControlHubEmulatorConfig;

  constructor(config: ControlHubEmulatorConfig) {
    this.config = config;
  ...
  public getConfig(): ControlHubEmulatorConfig {
    return this.config;
  }
